...
namespace GYM.Areas.Receptionist.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(string? id)
        {
            ...
            ViewData["Role"] = new SelectList(_db.Roles.ToList());
            ...
            //update dish
            user = await _unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id.Equals(id));
        ...
        public async Task<IActionResult> Upsert(ApplicationUser user)
        {
            ...
            if (ModelState.IsValid)
            {
                if (user.Id != null)
                {
                    ApplicationUser objFromDB = await _unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id.Equals(user.Id));
                }
        ...
        {
            var user = await _unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id == id);
