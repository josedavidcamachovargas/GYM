...
namespace GYM.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IConfiguration configuration, ISystemFacade systemFacade, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price")] Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                await _systemFacade.Operation(TableNames.Products_Table, product.Id.ToString(), "insert", product);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _systemFacade.Operation(TableNames.Products_Table, product.Id.ToString(), "update", product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _systemFacade.Operation(TableNames.Products_Table, product.Id.ToString(), "delete", product);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
